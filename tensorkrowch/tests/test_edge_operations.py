...
def test_svd_edge():
    ...
    node1 = tk.Node(shape=(2, 5, 3), axes_names=('left', 'contract', 'brratch1'), name='node1', init_method='randn')
    node2 = tk.Node(shape=(3, 5, 7), axes_names=('brratch2', 'contract', 'right'), name='node2', init_method='randn')
